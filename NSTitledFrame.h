...
+ (NSSize)_titleCellSizeForTitle:(id)fp8 styleMask:(NSUInteger)fp12;
...
- (NSRect)_validFrameForResizeFrame:(NSRect)fp8 fromResizeEdge:(NSInteger)fp24;
- (NSRect)frame:(NSRect)fp8 resizedFromEdge:(NSInteger)fp24 withDelta:(NSSize)fp28;
